...
def build_covariance_mat_from_scaling_rotation(scaling, scaling_modifier, rotation):
    L = build_scaling_rotation(scaling_modifier * scaling, rotation)
    return L @ L.transpose(1, 2)


def build_a_mat_from_scaling_rotation(scaling, scaling_modifier, rotation):
    return build_A_mat(scaling_modifier * scaling, rotation)
...
class GaussianModel(torch.nn.Module):
    def setup_functions(self):
        ...
        self.covariance_mat_activation = build_covariance_mat_from_scaling_rotation
        self.aell_mat_activation = build_a_mat_from_scaling_rotation
    ...
    def get_a_mat(self, scaling_modifier=1):
        return self.aell_mat_activation(
            self.get_scaling, scaling_modifier, self._rotation
        )
